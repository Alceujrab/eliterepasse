    ...
    <form wire:submit="save">
        ...
        <x-filament::section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Nome do Portal</label>
                    <input wire:model="site_nome" type="text"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                ...
                <div class="flex items-center gap-3 pt-6">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-medium text-gray-700">Aprovação Automática de Clientes</span>
                    </label>
                </div>
            </div>
        </x-filament::section>
        ...
        <x-filament::section class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Site Key (pública)</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Secret Key (privada)</label>
                    <input wire:model="google_recaptcha_secret_key" type="password"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-mono">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Score Mínimo (0.0=bot | 1.0=humano)</label>
                ...
                <div class="flex items-center gap-3 pt-6">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="w-11 h-6 bg-gray-200 peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-primary-600 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                        <span class="ml-3 text-sm font-medium text-gray-700">Ativar reCAPTCHA no Login</span>
                    </label>
                </div>
            </div>
        </x-filament::section>
        ...
        <x-filament::section class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Google Maps Geocoding API Key</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Google OAuth Client Secret</label>
        ...
        <x-filament::section class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">E-mail de Envio</label>
                    <input wire:model="mail_from_address" type="email"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm"
                        placeholder="noreply@eliterepasse.com.br">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Nome do Remetente</label>
        ...
        <div class="mt-6 flex justify-end">
            <button type="submit"
                class="inline-flex items-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition shadow-sm gap-2">
