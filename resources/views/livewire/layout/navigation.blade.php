                ...
                <x-slot name="content">
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-2 gap-x-12 gap-y-3">
                            <!-- Col 1 -->
                            <div class="space-y-1">
                                <a href="{{ route('meus-pedidos') }}" class="flex items-center gap-4 group p-3 hover:bg-[#f8fafc] rounded-xl transition" wire:navigate>
                            ...
                            <!-- Col 2 -->
                            <div class="space-y-1">
                                <a href="{{ route('favoritos') }}" class="flex items-center gap-4 group p-3 hover:bg-[#f8fafc] rounded-xl transition" wire:navigate>
                                ...
                                <a href="{{ route('notificacoes') }}" class="flex items-center gap-4 group p-3 hover:bg-[#f8fafc] rounded-xl transition" wire:navigate>
                                    <svg class="w-6 h-6 text-gray-400 group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                                    <span class="text-[16px] font-semibold text-gray-700 group-hover:text-primary transition-colors">Notificações</span>
                                </a>
